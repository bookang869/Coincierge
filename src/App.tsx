...
const GlobalStyle = createGlobalStyle`
  @import url('https://fonts.googleapis.com/css2?family=Cinzel&family=Source+Sans+Pro:wght@300;400&display=swap');
  ...
  * {
  ...
  a {
    ...
    color: inherit // color should follow that of the father
  }
`;
